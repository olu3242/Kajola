...
evals/evals.json                Test cases — 24 scenarios, 255 assertions
...
scripts/validate-skill.sh       Full skill structure validator (110 checks)
...
5. The skill passes overall if all 24 cases pass
