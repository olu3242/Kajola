...
evals/evals.json                Test cases — 32 scenarios, 351 assertions
...
scripts/validate-skill.sh       Full skill structure validator (119 checks)
...
5. The skill passes overall if all 32 cases pass
